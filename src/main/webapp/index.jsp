...
<%--&lt;%&ndash;                <a class="nav_link">${button_ua}</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <a class="nav_link">${button_en}</a>&ndash;%&gt;--%>
<%--                <form action="mainController?command=app_localization" method="post">--%>
<%--                    <button class="nav_link" type="submit" name="locale" value="ru">${button_ua}</button>--%>
...
<%--                    <div class="slider_item active">${masters}</div>--%>
<%--                    <div class="slider_item">${procedures}</div>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
